...
- **Побудова графіків і програмування на Python** (Епізоди 1-8 повністю перекладені та затверджені; в цілому 65% перекладу затверджено).
...
- **Програмування у системі компʼютерної алгебри GAP** (11% перекладу затверджено).
